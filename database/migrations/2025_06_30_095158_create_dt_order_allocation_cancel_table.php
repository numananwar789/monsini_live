...
return new class extends Migration
{
    ...
    {
        Schema::create('dt_order_allocation_cancel', function (Blueprint $table) {
             $table->integer('allocation_ID')->primary();
            $table->integer('final_ID')->default(0);
            ...
            $table->string('vendor_purchase_ID', 255)->default('NA');
            ...
            $table->timestamp('created_at_allocation')->useCurrent();
            ...
            $table->string('staging_flag', 255)->default('No');
            $table->string('staging_date', 255)->default('NA');
        });
    }
    ...
    {
        Schema::dropIfExists('dt_order_allocation_cancel');
    }
};
