    ...
    public function refresh()
    {
        ...
        DB::transaction(function () {
            ...
            foreach ($pendingOrders as $order) {
                // dd($order->order_product_style);


                // $onWayCount = OrderAllocation::where('order_product_style', "50068")
                //     ->where('order_product_color', "royal multi")
                //     ->where('order_product_size', "0")
                //     ->where('order_customer_name', $ownerComp) 
                //     ->where('order_quantity', '>', 0)
                //     ->sum('order_quantity');
                ...
                // if ($ordRemQuantity > 0) {
                //     $inventory = Inventory::where('product_ID', $order->order_product_ID)
                //         ->where('product_size', $order->order_product_size)
                //         ->where('product_quantity', '>=', $ordRemQuantity)
                //         ->first();
                ...
                //         // Update inventory
                //         $inventory->decrement('product_quantity', $ordRemQuantity);
                //     } else {
                //     }
                // }
            }
