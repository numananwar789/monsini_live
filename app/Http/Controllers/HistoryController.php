...
class HistoryController extends Controller
{
    public function index()
    {
        ...
        $orders = DB::table('dt_order')
            ...
            // JOIN product table using style
            ->leftJoin('dt_product', 'dt_order.order_product_style', '=', 'dt_product.product_style')
        
            // JOIN publish control table using version year
            ->leftJoin(
                'dt_product_year_control as pyc',
                'dt_product.version_year',
                '=',
                'pyc.year'
            )
