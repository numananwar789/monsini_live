...
class InventoryController extends Controller
{
    public function index()
    {
        ...
        // $totalInventoryCount = Inventory::sum('product_quantity');
    ...
    ->sum('product_quantity');
        ...
        // $totalList = Product::selectRaw('dt_product.*, 
        //         dt_inventory.product_size AS inventory_size, 
        //         dt_order_allocation.order_product_size AS onway_size, 
        //         SUM(dt_inventory.product_quantity) AS inventoryCount, 
        //         SUM(dt_order_allocation.order_quantity) AS onWayCount')
        //     ->leftJoin('dt_inventory', 'dt_product.product_ID', '=', 'dt_inventory.product_ID')
        //     ->leftJoin('dt_order_allocation', 'dt_product.product_ID', '=', 'dt_order_allocation.order_product_ID')
        //     ->groupBy(
        //         'dt_product.product_ID',
        //         'dt_inventory.product_size',
        //         'dt_order_allocation.order_product_size'
        //     )
        //     ->havingRaw('SUM(dt_inventory.product_quantity) > 0 OR SUM(dt_order_allocation.order_quantity) > 0')
        //     ->get();
