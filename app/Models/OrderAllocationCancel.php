...
class OrderAllocationCancel extends Model
{
    protected $table = 'dt_order_allocation_cancel';
    ...
    protected $fillable = [
        'final_ID', 'order_ID', 'order_customer_ID', 'order_customer_name',
        ...
        'onway_vndr_prchs_ids', 'onway_cstmr_prchs_ids', 'order_status', 'bypass',
        'order_wear_date', 'user_flag', 'order_GUID', 'staging_flag', 'staging_date' , 'sub_products'
    ];
}
