...
<option value="Cabo Verde" @if(old('country') == 'Cabo Verde') selected @endif>Cabo Verde</option>
...
<option value="Congo (Congo-Brazzaville)" @if(old('country') == 'Congo (Congo-Brazzaville)') selected @endif>Congo (Congo-Brazzaville)</option>
...
<option value="Democratic Republic of the Congo" @if(old('country') == 'Democratic Republic of the Congo') selected @endif>Democratic Republic of the Congo</option>
...
<option value="Eswatini" @if(old('country') == 'Eswatini') selected @endif>Eswatini</option>
...
<option value="Myanmar (Burma)" @if(old('country') == 'Myanmar (Burma)') selected @endif>Myanmar (Burma)</option>
...
<option value="North Macedonia" @if(old('country') == 'North Macedonia') selected @endif>North Macedonia</option>
